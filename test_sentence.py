...
# Load the model
l_model = load_model('combined_aaa.keras')
...
while True:
    ...
    # Preprocess the frame for the l_model
    ...
    # For Speaking out the sentence
    cv2.putText(frame, "Press 'r' to Speak_aloud the sentence", (10, 150),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
